...
const LifetimeMembership = () => {
    ...
    return (
      <div className="mem-page">
        <div className="mem-success-overlay">
          <div className="mem-thankyou mem-thankyou-popup lifetime-thankyou">
  ...
  return (
    <div className="mem-page">
      <div className="mem-header lifetime-header">
        <div className="mem-header-badge lifetime-badge">Lifetime Plan</div>
        <h1>Lifetime Membership Application</h1>
        <p>Fill in your details below. Our team will reach out regarding payment and next steps.</p>
        <div className="mem-fee-tag lifetime-fee-tag">Lifetime Fee: ₹10,000 &nbsp;|&nbsp; One-Time Payment</div>
      </div>
        ...
        <form className="mem-form" onSubmit={handleSubmit} noValidate>
          ...
          <div className="mem-section">
            <div className="mem-section-head">
              <span className="mem-num lifetime-num">01</span><h3>Personal Information</h3>
            </div>
          ...
          <div className="mem-section">
            <div className="mem-section-head">
              <span className="mem-num lifetime-num">02</span><h3>Contact Details</h3>
            </div>
            <div className="mem-grid">
          ...
          <div className="mem-section">
            <div className="mem-section-head">
              <span className="mem-num lifetime-num">03</span><h3>Professional Details</h3>
            </div>
            <div className="mem-grid">
          ...
          <div className="mem-section">
            <div className="mem-section-head">
              <span className="mem-num lifetime-num">04</span><h3>Document Uploads</h3>
            </div>
          ...
          <button type="submit" className="mem-submit lifetime-submit">
            Submit Application →
          </button>
        </form>
      </div>
        ...
        <div className="mem-modal-overlay">
          <div className="mem-modal">
            ...
            <div className="mem-modal-actions">
              ...
              <button
                className={`mem-modal-confirm lifetime-confirm ${(!agreeTerms || !agreePrivacy || submitting) ? "disabled" : ""}`}
