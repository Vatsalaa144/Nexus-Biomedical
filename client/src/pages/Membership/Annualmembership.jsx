    ...
    <div className="mem-page">
      ...
      <div className="mem-hero-banner">
        <div className="mem-hero-content">
          <h1 className="mem-hero-title">Annual Membership Application</h1>
          ...
          <div className="mem-grid-layout">
            ...
            <div className={`mem-step-card mem-cs-${cs(0)}`}>
              <div className="mem-card-header">
                ...
                {cs(0) === "done" && (
                  <button type="button" className="mem-edit-btn annual-edit" onClick={() => { setStep(0); setErrors({}); }}>✎ Edit</button>
                )}
              </div>
              <div className="mem-card-body">
                ...
                {step === 0 && (
                  <div className="mem-card-nav">
                    <button type="button" className="mem-btn-confirm annual-confirm-btn" onClick={handleNext}>
            ...
            <div className={`mem-step-card mem-cs-${cs(1)}`}>
              <div className="mem-card-header">
                ...
                {cs(1) === "done" && (
                  <button type="button" className="mem-edit-btn annual-edit" onClick={() => { setStep(1); setErrors({}); }}>✎ Edit</button>
                )}
              </div>
              <div className="mem-card-body">
                <div className="mem-grid">
            ...
            <div className={`mem-step-card mem-cs-${cs(2)}`}>
              <div className="mem-card-header">
                ...
                {cs(2) === "done" && (
                  <button type="button" className="mem-edit-btn annual-edit" onClick={() => { setStep(2); setErrors({}); }}>✎ Edit</button>
                )}
              </div>
              <div className="mem-card-body">
                <div className="mem-grid">
            ...
            <div className={`mem-step-card mem-cs-${cs(3)}`}>
              ...
              <div className="mem-card-body">
                ...
                {step === 3 && (
                  <div className="mem-card-nav">
                    <button type="button" className="mem-btn-back" onClick={handleBack}>← Back</button>
                    <button type="submit" className="mem-btn-confirm annual-confirm-btn">
      ...
      {showDisclaimer && (
        <div className="mem-modal-overlay">
          <div className={`mem-modal${submitting ? " mem-submit-modal" : ""}`}>
            {submitting ? (
              <div className="mem-submit-state annual-submit-state">
            ...
            <div className="mem-modal-actions">
              ...
              <button className="mem-modal-back" onClick={() => setShowDisclaimer(false)} disabled={submitting}>← Go Back</button>
              <button
